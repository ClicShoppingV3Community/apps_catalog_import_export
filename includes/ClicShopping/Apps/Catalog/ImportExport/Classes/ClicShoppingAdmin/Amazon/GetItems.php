<?php
  ...
  class GetItems {
    ...
    public function __construct() {
      $this->setAccessKey = HTML::sanitize($_POST['access_key']);
      $this->setSecretKey = HTML::sanitize($_POST['secret_key']);
      $this->setRegion = HTML::sanitize($_POST['region']);
      $this->setHost  = HTML::sanitize($_POST['host']);
      $this->partnerTag = HTML::sanitize($_POST['partner_tag']);

      $config = new Configuration();
/*
      $apiInstance = new DefaultApi(HTTP::getResponse($config));
...
# Choose item id(s)
    ...
    public function getItemsWithHttpInfo()
  {
      ...
      # Sending the request
      try {
          $responseWithHttpInfo = $this->apiInstance->getItemsWithHttpInfo($getItemsRequest);
    ...
    public function getItemsAsync()
  {
      ...
      # Sending the request
      try {
          $promise = $this->apiInstance->getItemsAsync($getItemsRequest);
    ...
    public function getItemsAsyncWithHttpInfo()
  {
      ...
      # Sending the request
      try {
          $promise = $this->apiInstance->getItemsAsyncWithHttpInfo($getItemsRequest);
