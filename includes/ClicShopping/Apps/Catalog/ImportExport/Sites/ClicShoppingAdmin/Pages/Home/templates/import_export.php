            ...
            <div class="col-md-6">
              <div class="card"><div class="card-header alert-primary">
                ...
                <div class="card-body">
                  ...
                  <div class="separator"></div>
                  <div class="form-group row" id="products_import_output_quick_update">
                      <label for="<?php echo $CLICSHOPPING_ImportExport->getDef('text_all_import_quick_update'); ?>"
                             class="col-6 col-form-label"><?php echo $CLICSHOPPING_ImportExport->getDef('text_all_import_quick_update'); ?></label>
                      <div class="col-md-5">
                        <ul class="list-group-slider list-group-flush">
                          <li class="list-group-item-slider">
                            <label class="switch">
                              <?php echo HTML::checkboxField('import_all_products', '0', null, 'class="success"'); ?>
                  ...
                  <div class="form-group row" id="products_import_input_field_quick_update">
                    <label for="<?php echo $CLICSHOPPING_ImportExport->getDef('text_import_quick_update'); ?>"
                           class="col-6 col-form-label"><?php echo $CLICSHOPPING_ImportExport->getDef('text_import_quick_update'); ?></label>
                    <div class="col-md-5">
                      <ul class="list-group-slider list-group-flush">
                        <li class="list-group-item-slider">
                          <label class="switch">
                            <?php echo HTML::checkboxField('import_products_quick_update', '0', null, 'class="success"'); ?>
                            <span class="slider"></span>
                          </label>
                        </li>
                      </ul>
                  ...
                  <div class="form-group row" id="products_import_output_quick_update_amazon">
                    <label for="<?php echo $CLICSHOPPING_ImportExport->getDef('text_import_quick_update_amazon'); ?>"
                           class="col-6 col-form-label text-primary"><?php echo $CLICSHOPPING_ImportExport->getDef('text_import_quick_update_amazon'); ?></label>
                    <div class="col-md-5">
                      <ul class="list-group-slider list-group-flush">
                        <li class="list-group-item-slider">
                          <label class="switch">
                            <?php echo HTML::checkboxField('import_products_quick_update_amazon', '0', null, 'class="success"'); ?>
                            <span class="slider"></span>
                          </label>
                        </li>
                      </ul>
            ...
            <div class="col-md-6">
              <div class="card"><div class="card-header alert-primary">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row" id="products_export_output_quick_update">
                    <label for="<?php echo $CLICSHOPPING_ImportExport->getDef('text_all_export_quick_update'); ?>"
                           class="col-6 col-form-label"><?php echo $CLICSHOPPING_ImportExport->getDef('text_all_export_quick_update'); ?></label>
                    <div class="col-md-5">
                      <ul class="list-group-slider list-group-flush">
                        <li class="list-group-item-slider">
                          <label class="switch">
                            <?php echo HTML::checkboxField('export_all_products', '0', null, 'class="success"'); ?>
                            <span class="slider"></span>
                          </label>
                        </li>
                      </ul>
                  ...
                  <div class="form-group row" id="products_export_inputfield_quick_update">
                    <label for="<?php echo $CLICSHOPPING_ImportExport->getDef('text_export_quick_update'); ?>"
                           class="col-6 col-form-label"><?php echo $CLICSHOPPING_ImportExport->getDef('text_export_quick_update'); ?></label>
                    <div class="col-md-5">
                      <ul class="list-group-slider list-group-flush">
                        <li class="list-group-item-slider">
                          <label class="switch">
                            <?php echo HTML::checkboxField('export_quick_update', '0', null, 'class="success"'); ?>
                            <span class="slider"></span>
                          </label>
                        </li>
                      </ul>
                  ...
                  <div class="form-group row" id="products_export_output_quick_update_amazon">
                    <label for="<?php echo $CLICSHOPPING_ImportExport->getDef('text_export_quick_update_amzon'); ?>"
                           class="col-6 col-form-label text-primary"><?php echo $CLICSHOPPING_ImportExport->getDef('text_export_quick_update_amzon'); ?></label>
                    <div class="col-md-5">
                      <ul class="list-group-slider list-group-flush">
                        <li class="list-group-item-slider">
                          <label class="switch">
                            <?php echo HTML::checkboxField('export_quick_update_amazon', '0', null, 'class="success"'); ?>
                            <span class="slider"></span>
                          </label>
                        </li>
                      </ul>
